...
if __name__ == "__main__":
    ...
    create_no_category_db("./CSV/eating_disorder.csv", EatingDisorder)
    create_no_category_db("./CSV/exercise.csv", Exercise)
    create_no_category_db("./CSV/food_and_drinks.csv", FoodAndDrinks)
